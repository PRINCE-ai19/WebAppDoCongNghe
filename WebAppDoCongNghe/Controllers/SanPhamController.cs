...
namespace WebAppDoCongNghe.Controllers
{
    ...
    public class SanPhamController : ControllerBase
    {
        ...
        // Helper method d? tính giá gi?m t? khuy?n mãi dang active
        ...
        public IActionResult GetPaging(int page , int pageSize )
        {
            ...
            var query = _context.SanPhams
                ...
                .ToList()
                .Select(p => {
                    // Tính giá gi?m t? khuy?n mãi dang active
                    ...
                    // Uu tiên giá gi?m t? khuy?n mãi, n?u không có thì dùng giá gi?m cu
       ...
       [HttpGet]
        ...
        public IActionResult GetById(int id)
        {
            ...
            if (product == null)
            {
                ...
                {
                    Success = false,
                    Message = "Không tìm th?y s?n ph?m"
                });
            }
        ...
        public IActionResult GetByCategory(int categoryId)
        {
            ...
            if (products == null || products.Count == 0)
            {
                ...
                {
                    Success = false,
                    Message = "Không có s?n ph?m nào thu?c danh m?c này"
                });
            }
            ...
            var result = products.Select(p => {
                ...
                return new
                {
                    ...
                    // ?nh d?i di?n: l?y URL d?u tiên trong danh sách hình c?a s?n ph?m
        ...
        public async Task<IActionResult> Update(int id, [FromForm] SannPhamBind model)
        {
            ...
            if (product == null)
                return NotFound(new ApiRespone { Success = false, Message = "Không tìm th?y s?n ph?m" });
        ...
        public IActionResult Search(string keyword)
        {
            if (string.IsNullOrWhiteSpace(keyword))
            {
                ...
                {
                    Success = false,
                    Message = "Vui lòng nh?p t? khóa tìm ki?m."
                });
            }
            ...
            if (!products.Any())
            {
                ...
                {
                    Success = false,
                    Message = "Không tìm th?y s?n ph?m nào phù h?p v?i t? khóa tìm ki?m."
                });
            }
            ...
            {
                Success = true,
                Message = $"K?t qu? tìm ki?m cho '{keyword}'",
                Data = products
            });
        }
