...
namespace WebAppDoCongNghe.Controllers
{
    ...
    public class TinTucController : ControllerBase
    {
        ...
        public IActionResult AdminGetAll(int page, int pageSize)
        {
            ...
            {
                success = true,
                message = "L?y danh sách tin t?c thành công",
                data = new
                {
                    items = items,
                    total = total,
        ...
        public IActionResult GetById(int id)
        {
            ...
            if (tin == null)
                return NotFound("Không tìm th?y tin t?c");
        ...
        public async Task<IActionResult> CreateAsync([FromForm] TinTucRequest request)
        {
            ...
            {
                Success = true,
                Message = "Thêm tin t?c thành công",
                Data = tin
            });
        }
        ...
        public async Task<IActionResult> UpdateAsync(int id, [FromForm] TinTucRequest request)
        {
            ...
            {
                Success = true,
                Message = "C?p nh?t tin t?c thành công",
                Data = tin
            });
        }
        ...
        public async Task<IActionResult> DeleteAsync(int id)
        {
            ...
            {
                Success = true,
                Message = "Xoá tin t?c thành công"
            });
        }
